...
def generate_launch_description():
    gestelt_bringup_dir = get_package_share_directory('gestelt_bringup')
    ...
    map_yaml_file = os.path.join(gestelt_bringup_dir, 'maps', 'depot.yaml')
    ...
    rviz_cmd = IncludeLaunchDescription(
        PythonLaunchDescriptionSource(
            os.path.join(gestelt_bringup_dir, 'launch', 'rviz_launch.py')
        ),
    ...
    bringup_cmd = IncludeLaunchDescription(
        PythonLaunchDescriptionSource(
            os.path.join(gestelt_bringup_dir, 'launch', 'bringup_launch.py')
        ),
