...
/ros_entrypoint.sh \
ros2 launch gestelt_bringup offboard_uav.py drone_id:=${DRONE_ID} scenario_name:=start_4d \
"
...
then 
    ...
    tmux send-keys -t $SESSION:0.2 "sleep 2 && $ROS2_TO_ROS1_BRIDGE" C-m
    ...
    # tmux send-keys -t $SESSION:0.5 "sleep 27 && $RESTART_VINS" C-m
fi
