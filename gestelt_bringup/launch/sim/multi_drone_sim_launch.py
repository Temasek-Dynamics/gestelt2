...
def launch_setup(context):
    ...
    declare_rviz_config_file_cmd = DeclareLaunchArgument(
        'rviz_config_file',
        default_value=os.path.join(bringup_dir, 'rviz', 'five_drones.rviz'),
    ...
    for drone_id in range(scenario.num_agents):
                            ...
                            actions=[
                                ...
                                ExecuteProcess(
                                    ...
                                    cmd=[
                                        ...
                                        'ROS_DOMAIN_ID=1', # Use with hifisim
        ...
        agent_bringups.append(agent_bringup)
