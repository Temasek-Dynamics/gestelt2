...
foreach(_expectedTarget ikd_tree::ikd_tree)
...
# Create imported target ikd_tree::ikd_tree
add_library(ikd_tree::ikd_tree SHARED IMPORTED)

set_target_properties(ikd_tree::ikd_tree PROPERTIES
  INTERFACE_COMPILE_FEATURES "c_std_99;cxx_std_17"
  INTERFACE_INCLUDE_DIRECTORIES "${_IMPORT_PREFIX}/include/ikd_tree"
...
file(GLOB CONFIG_FILES "${_DIR}/export_ikd_treeExport-*.cmake")
